...
function UpgradeModal({ plan, onClose, onSuccess }: { plan: "launch" | "founder"; onClose: () => void; onSuccess: (p: Plan) => void }) {
  const info = {
    launch: {
      ...
      feats: ["AI reads your actual website", "10 best-match communities", "15 posts per platform", "15-day launch calendar", "Reddit · LinkedIn · Twitter · WhatsApp", "Distribution map", "Cold outreach bundle (4 emails)", "Landing page improvements", "Launch readiness scorecard"],
    },
    founder: {
